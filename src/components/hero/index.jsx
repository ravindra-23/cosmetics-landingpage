      ...
      <div className="mx-auto w-5/6 items-center justify-center md:flex md:h-5/6">
        ...
        >
          <div className="z-10 mt-32 md:basis-3/5">
            <div className="md:-mt-20">
              ...
              <p className="text-[18px] md:text-[20px] font-poppins text-body my-10">
            ...
            <div className="mt-8 flex items-center gap-8">
              ...
              <button className="flex items-center justify-between md:gap-5 border-none bg-white text-[18px] md:text-[20px] text-body font-poppins">
        ...
        <div className="flex basis-3/5 justify-center md:z-10 md:ml-40 md:mt-16 md:justify-items-end mt-5">
          {isAboveMediumScreens ? (
            <ScrollParallax>
              <img
                className="w-[350px] md:w-4/5 h-auto"
                src={HeroImage}
                alt="hero"
              />
            </ScrollParallax>
          ) : (
            <img className="w-[350px]" src={HeroImage} alt="hero" />
          )}
        </div>
      </div>
    </section>
